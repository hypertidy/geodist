...
par (mfrow = c (1, 2))
plot (d1mod$x, d1mod$y, "l", log = "xy", xlim = c (1, max (d1mod$x)),
      ylim = range (c (d1mod$y, d2mod$y)),
      xlab = "distance (km)", ylab = "error", main = "Absolute error (m)")
lines (d1mod$x, d1mod$x, col = "grey", lty = 2)
lines (d2mod$x, d2mod$y, col = "grey")
...
lines (d2mod$x / 1000, 100 * d2mod$y, col = "grey")
```
![](fig/README-plot-1.png)

The absolute error increases with increasing distance as expected, yet the
relative error remains generally constant at around 0.2%.
