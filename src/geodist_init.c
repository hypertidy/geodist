...
extern SEXP R_vincenty_ellips(SEXP);
extern SEXP R_vincenty_ellips_xy(SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"R_vincenty_ellips",    (DL_FUNC) &R_vincenty_ellips,    1},
    {"R_vincenty_ellips_xy", (DL_FUNC) &R_vincenty_ellips_xy, 2},
